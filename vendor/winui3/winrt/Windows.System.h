...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_System_IUser3<D>::GetUserAgeRangeAsync() const
    {
        void* operation{};
        if constexpr (!std::is_same_v<D, winrt::Windows::System::IUser3>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::System::IUser3, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUser3>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetUserAgeRangeAsync(&operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUser3>**)this;
            check_hresult(_winrt_abi_type->GetUserAgeRangeAsync(&operation));
        }
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::System::UserAgeRange>{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_IUser3<D>::GetAgeVerificationStatusAsync() const
    {
        void* operation{};
        if constexpr (!std::is_same_v<D, winrt::Windows::System::IUser3>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUser3>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetAgeVerificationStatusAsync(&operation));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUser3>**)this;
        ...
        return winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::System::UserAgeVerificationStatus>{ operation, take_ownership_from_abi };
    }
    template <typename D> auto consume_Windows_System_IUserAgeRange<D>::Lower() const
    {
        int32_t value{};
        if constexpr (!std::is_same_v<D, winrt::Windows::System::IUserAgeRange>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::System::IUserAgeRange, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUserAgeRange>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_Lower(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUserAgeRange>**)this;
            check_hresult(_winrt_abi_type->get_Lower(&value));
        }
        return value;
    }
    template <typename D> auto consume_Windows_System_IUserAgeRange<D>::Upper() const
    {
        int32_t value{};
        if constexpr (!std::is_same_v<D, winrt::Windows::System::IUserAgeRange>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUserAgeRange>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_Upper(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::System::IUserAgeRange>**)this;
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::System::IUser3> : produce_base<D, winrt::Windows::System::IUser3>
    {
        int32_t __stdcall GetUserAgeRangeAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::System::UserAgeRange>>(this->shim().GetUserAgeRangeAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall GetAgeVerificationStatusAsync(void** operation) noexcept final try
        {
            clear_abi(operation);
            typename D::abi_guard guard(this->shim());
            *operation = detach_from<winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::System::UserAgeVerificationStatus>>(this->shim().GetAgeVerificationStatusAsync());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::System::IUserAgeRange> : produce_base<D, winrt::Windows::System::IUserAgeRange>
    {
        int32_t __stdcall get_Lower(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<int32_t>(this->shim().Lower());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall get_Upper(int32_t* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<int32_t>(this->shim().Upper());
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
namespace std
{
    ...
    template<> struct hash<winrt::Windows::System::IUser3> : winrt::impl::hash_base {};
    template<> struct hash<winrt::Windows::System::IUserAgeRange> : winrt::impl::hash_base {};
    ...
    template<> struct hash<winrt::Windows::System::UserAgeRange> : winrt::impl::hash_base {};
