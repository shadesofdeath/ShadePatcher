...
namespace winrt::impl
{
    ...
    template <typename D> auto consume_Windows_UI_Input_IGamepadKeyRoutingConfigurationStatics<D>::IsSupported() const
    {
        bool result{};
        if constexpr (!std::is_same_v<D, winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->IsSupported(&result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>**)this;
            check_hresult(_winrt_abi_type->IsSupported(&result));
        }
        return result;
    }
    template <typename D> auto consume_Windows_UI_Input_IGamepadKeyRoutingConfigurationStatics<D>::IsKeyRoutingEnabled() const
    {
        bool value{};
        if constexpr (!std::is_same_v<D, winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_IsKeyRoutingEnabled(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>**)this;
    ...
    template <typename D> auto consume_Windows_UI_Input_IGamepadKeyRoutingConfigurationStatics<D>::TrySetKeyRoutingEnabled(bool enabled) const
    {
        bool result{};
        if constexpr (!std::is_same_v<D, winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->TrySetKeyRoutingEnabled(enabled, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>**)this;
...
#ifndef WINRT_LEAN_AND_MEAN
    template <typename D>
    struct produce<D, winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics> : produce_base<D, winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics>
    {
        ...
        int32_t __stdcall get_IsKeyRoutingEnabled(bool* value) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *value = detach_from<bool>(this->shim().IsKeyRoutingEnabled());
            return 0;
        }
        catch (...) { return to_hresult(); }
        int32_t __stdcall TrySetKeyRoutingEnabled(bool enabled, bool* result) noexcept final try
        {
            typename D::abi_guard guard(this->shim());
            *result = detach_from<bool>(this->shim().TrySetKeyRoutingEnabled(enabled));
            return 0;
        }
        catch (...) { return to_hresult(); }
    };
...
WINRT_EXPORT namespace winrt::Windows::UI::Input
{
    ...
    inline auto GamepadKeyRoutingConfiguration::IsSupported()
    {
        return impl::call_factory_cast<bool(*)(IGamepadKeyRoutingConfigurationStatics const&), GamepadKeyRoutingConfiguration, IGamepadKeyRoutingConfigurationStatics>([](IGamepadKeyRoutingConfigurationStatics const& f) { return f.IsSupported(); });
    }
    inline auto GamepadKeyRoutingConfiguration::IsKeyRoutingEnabled()
    {
        return impl::call_factory_cast<bool(*)(IGamepadKeyRoutingConfigurationStatics const&), GamepadKeyRoutingConfiguration, IGamepadKeyRoutingConfigurationStatics>([](IGamepadKeyRoutingConfigurationStatics const& f) { return f.IsKeyRoutingEnabled(); });
    }
    inline auto GamepadKeyRoutingConfiguration::TrySetKeyRoutingEnabled(bool enabled)
    {
        return impl::call_factory<GamepadKeyRoutingConfiguration, IGamepadKeyRoutingConfigurationStatics>([&](IGamepadKeyRoutingConfigurationStatics const& f) { return f.TrySetKeyRoutingEnabled(enabled); });
    }
...
namespace std
{
    ...
    template<> struct hash<winrt::Windows::UI::Input::IGamepadKeyRoutingConfigurationStatics> : winrt::impl::hash_base {};
    ...
    template<> struct hash<winrt::Windows::UI::Input::GamepadKeyRoutingConfiguration> : winrt::impl::hash_base {};
