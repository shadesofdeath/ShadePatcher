...
namespace winrt::impl
{
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_LowRankAdapter(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterResult>**)this;
            check_hresult(_winrt_abi_type->get_LowRankAdapter(&value));
        }
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->CreateFromPath(*(void**)(&filePath), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ILanguageModelLowRankAdapterStatics>**)this;
            check_hresult(_winrt_abi_type->CreateFromPath(*(void**)(&filePath), &result));
        }
    ...
    {
        void* value{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->get_LowRankAdapter(&value));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::AI::Text::ILanguageModelOptions2>**)this;
            check_hresult(_winrt_abi_type->get_LowRankAdapter(&value));
        }
        return winrt::Microsoft::Windows::AI::Text::LanguageModelLowRankAdapter{ value, take_ownership_from_abi };
    }
    ...
    {
        int32_t __stdcall CreateFromPath(void* filePath, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
