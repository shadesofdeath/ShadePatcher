...
WINRT_EXPORT namespace winrt::Microsoft::Windows::VisionInternal
{
    ...
    enum class RecognizedTableCellKindInternal : int32_t
    {
        Content = 0,
        RowHeader = 1,
        ColumnHeader = 2,
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellInternal>{ using type = struct_category<int32_t, int32_t, int32_t, int32_t, hstring, winrt::Microsoft::Windows::VisionInternal::BoundingBox, winrt::Microsoft::Windows::VisionInternal::RecognizedTableCellKindInternal>; };
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::RecognizedTableInternal>{ using type = struct_category<int32_t, int32_t, winrt::Microsoft::Windows::VisionInternal::BoundingBox, uint32_t>; };
    ...
    template <> struct category<winrt::Microsoft::Windows::VisionInternal::TableRecognizerOptionsInternal>{ using type = struct_category<uint32_t, bool>; };
    ...
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>
    {
        ...
        {
            virtual int32_t __stdcall GetTables(uint32_t* __resultSize, struct struct_Microsoft_Windows_VisionInternal_RecognizedTableInternal**) noexcept = 0;
            virtual int32_t __stdcall GetTableCells(uint32_t, uint32_t* __resultSize, struct struct_Microsoft_Windows_VisionInternal_RecognizedTableCellInternal**) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall RecognizeTableFromImage(void*, struct struct_Microsoft_Windows_VisionInternal_TableRecognizerOptionsInternal, uint32_t, winrt::Windows::Foundation::Rect*, void**) noexcept = 0;
        };
    };
    template <typename D>
    struct consume_Microsoft_Windows_VisionInternal_IRecognizedTablesInternal
    {
        ...
        auto GetTableCells(uint32_t tableIndex) const;
    };
