...
WINRT_EXPORT namespace winrt::Windows::UI::Input
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IGamepadKeyRoutingConfigurationStatics :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IGamepadKeyRoutingConfigurationStatics>
    {
        IGamepadKeyRoutingConfigurationStatics(std::nullptr_t = nullptr) noexcept {}
        IGamepadKeyRoutingConfigurationStatics(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
