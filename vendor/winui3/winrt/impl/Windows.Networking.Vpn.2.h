...
WINRT_EXPORT namespace winrt::Windows::Networking::Vpn
{
    ...
    struct WINRT_IMPL_EMPTY_BASES VpnChannel : winrt::Windows::Networking::Vpn::IVpnChannel,
        impl::require<VpnChannel, winrt::Windows::Networking::Vpn::IVpnChannel2, winrt::Windows::Networking::Vpn::IVpnChannel4, winrt::Windows::Networking::Vpn::IVpnChannel5, winrt::Windows::Networking::Vpn::IVpnChannel6, winrt::Windows::Networking::Vpn::IVpnChannel7Preview>
    {
        ...
        using winrt::Windows::Networking::Vpn::IVpnChannel::SetErrorMessage;
        using impl::consume_t<VpnChannel, winrt::Windows::Networking::Vpn::IVpnChannel7Preview>::SetErrorMessage;
    ...
    struct WINRT_IMPL_EMPTY_BASES VpnConnectionDetailsPreview : winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview
    {
        VpnConnectionDetailsPreview(std::nullptr_t) noexcept {}
        VpnConnectionDetailsPreview(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES VpnManagementAgent : winrt::Windows::Networking::Vpn::IVpnManagementAgent,
        impl::require<VpnManagementAgent, winrt::Windows::Networking::Vpn::IVpnManagementAgent2Preview>
    {
