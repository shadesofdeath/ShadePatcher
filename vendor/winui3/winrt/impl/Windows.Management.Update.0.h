...
namespace winrt::impl
{
    ...
    template <> inline constexpr guid guid_v<winrt::Windows::Management::Update::IWindowsSoftwareUpdateProvider>{ 0xB573A766,0x0C05,0x575A,{ 0xA9,0x48,0xDA,0x82,0xA5,0x9E,0x78,0x2B } }; // B573A766-0C05-575A-A948-DA82A59E782B
    ...
    template <> struct abi<winrt::Windows::Management::Update::IWindowsSoftwareUpdateProvider>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            ...
            virtual int32_t __stdcall get_ProviderIdentity(void**) noexcept = 0;
            virtual int32_t __stdcall get_Properties(void**) noexcept = 0;
            virtual int32_t __stdcall GetPropertyValue(void*, void**) noexcept = 0;
        };
    };
    ...
    struct consume_Windows_Management_Update_IWindowsSoftwareUpdateProvider
    {
        ...
        [[nodiscard]] auto ProviderIdentity() const;
        [[nodiscard]] auto Properties() const;
        auto GetPropertyValue(param::hstring const& name) const;
    };
