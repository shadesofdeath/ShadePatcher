...
namespace winrt::impl
{
    ...
    template <> struct abi<winrt::Microsoft::UI::Xaml::Markup::IXamlBindingHelperStatics2>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall SetPropertyFromThickness(void*, void*, struct struct_Microsoft_UI_Xaml_Thickness) noexcept = 0;
            virtual int32_t __stdcall SetPropertyFromCornerRadius(void*, void*, struct struct_Microsoft_UI_Xaml_CornerRadius) noexcept = 0;
            virtual int32_t __stdcall SetPropertyFromColor(void*, void*, struct struct_Windows_UI_Color) noexcept = 0;
        };
    };
