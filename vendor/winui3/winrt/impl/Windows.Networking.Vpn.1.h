...
WINRT_EXPORT namespace winrt::Windows::Networking::Vpn
{
    ...
    struct WINRT_IMPL_EMPTY_BASES IVpnChannel7Preview :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IVpnChannel7Preview>
    {
        IVpnChannel7Preview(std::nullptr_t = nullptr) noexcept {}
        IVpnChannel7Preview(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES IVpnConnectionDetailsPreview :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IVpnConnectionDetailsPreview>
    {
        IVpnConnectionDetailsPreview(std::nullptr_t = nullptr) noexcept {}
        IVpnConnectionDetailsPreview(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
    ...
    struct WINRT_IMPL_EMPTY_BASES IVpnManagementAgent2Preview :
        winrt::Windows::Foundation::IInspectable,
        impl::consume_t<IVpnManagementAgent2Preview>
    {
        IVpnManagementAgent2Preview(std::nullptr_t = nullptr) noexcept {}
        IVpnManagementAgent2Preview(void* ptr, take_ownership_from_abi_t) noexcept : winrt::Windows::Foundation::IInspectable(ptr, take_ownership_from_abi) {}
    };
