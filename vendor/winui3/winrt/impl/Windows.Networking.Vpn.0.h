...
WINRT_EXPORT namespace winrt::Windows::Networking::Vpn
{
    ...
    enum class VpnConnectionTypePreview : int32_t
    {
        NoConnection = 0,
        PlatformUXInitiated = 1,
        ApiInitiated = 2,
        Auto = 3,
        FastReconnect = 4,
        PluginCrashReconnect = 5,
    };
    ...
    enum class VpnDisconnectReasonPreview : int32_t
    {
        Unknown = 0,
        NotDisconnected = 1,
        PlatformUXInitiated = 2,
        ApiInitiated = 3,
        Standby = 4,
        NetworkFailure = 5,
        ServiceStop = 6,
        ...
        Shutdown = 8,
        PluginUninstall = 9,
        CaptivePortalDetected = 10,
        AppTriggerDisconnect = 11,
        EnteredTrustedNetwork = 12,
    };
    ...
    struct IVpnConnectionDetailsPreview;
    ...
    struct IVpnManagementAgent2Preview;
    ...
    struct VpnConnectionDetailsPreview;
...
namespace winrt::impl
{
    ...
    template <> struct category<winrt::Windows::Networking::Vpn::IVpnChannel7Preview>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Windows::Networking::Vpn::IVpnManagementAgent2Preview>{ using type = interface_category; };
    ...
    template <> struct category<winrt::Windows::Networking::Vpn::VpnConnectionDetailsPreview>{ using type = class_category; };
    ...
    template <> struct category<winrt::Windows::Networking::Vpn::VpnConnectionTypePreview>{ using type = enum_category; };
    ...
    template <> struct category<winrt::Windows::Networking::Vpn::VpnDisconnectReasonPreview>{ using type = enum_category; };
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::Networking::Vpn::VpnConnectionDetailsPreview> = L"Windows.Networking.Vpn.VpnConnectionDetailsPreview";
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::Networking::Vpn::VpnConnectionTypePreview> = L"Windows.Networking.Vpn.VpnConnectionTypePreview";
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::Networking::Vpn::VpnDisconnectReasonPreview> = L"Windows.Networking.Vpn.VpnDisconnectReasonPreview";
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::Networking::Vpn::IVpnChannel7Preview> = L"Windows.Networking.Vpn.IVpnChannel7Preview";
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview> = L"Windows.Networking.Vpn.IVpnConnectionDetailsPreview";
    ...
    template <> inline constexpr auto& name_v<winrt::Windows::Networking::Vpn::IVpnManagementAgent2Preview> = L"Windows.Networking.Vpn.IVpnManagementAgent2Preview";
    ...
    template <> inline constexpr guid guid_v<winrt::Windows::Networking::Vpn::IVpnChannel7Preview>{ 0x19862972,0xF14B,0x406B,{ 0xBF,0x10,0xF7,0x2E,0xE3,0x23,0x77,0x1B } }; // 19862972-F14B-406B-BF10-F72EE323771B
    ...
    template <> inline constexpr guid guid_v<winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview>{ 0xBBD3E70B,0x1AB8,0x49C9,{ 0x9F,0xB1,0xDC,0x78,0x56,0x40,0x58,0xD4 } }; // BBD3E70B-1AB8-49C9-9FB1-DC78564058D4
    ...
    template <> inline constexpr guid guid_v<winrt::Windows::Networking::Vpn::IVpnManagementAgent2Preview>{ 0x73791CC7,0xACD7,0x491B,{ 0x8B,0xED,0xE9,0xA1,0x7C,0x34,0x33,0xDA } }; // 73791CC7-ACD7-491B-8BED-E9A17C3433DA
    ...
    template <> struct default_interface<winrt::Windows::Networking::Vpn::VpnConnectionDetailsPreview>{ using type = winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview; };
    ...
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnChannel7Preview>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall SetErrorMessageWithDetails(void*, uint32_t) noexcept = 0;
            virtual int32_t __stdcall get_ConnectionDetail(void**) noexcept = 0;
            virtual int32_t __stdcall get_DisconnectReason(int32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall get_Type(int32_t*) noexcept = 0;
            virtual int32_t __stdcall get_Attempt(uint32_t*) noexcept = 0;
        };
    };
    ...
    template <> struct abi<winrt::Windows::Networking::Vpn::IVpnManagementAgent2Preview>
    {
        struct WINRT_IMPL_NOVTABLE type : inspectable_abi
        {
            virtual int32_t __stdcall GetAlwaysOnActiveProfile(void**) noexcept = 0;
            virtual int32_t __stdcall GetAlwaysOnActiveProfileAsync(void**) noexcept = 0;
            virtual int32_t __stdcall SetAlwaysOnActiveProfile(void*) noexcept = 0;
            virtual int32_t __stdcall SetAlwaysOnActiveProfileAsync(void*, void**) noexcept = 0;
        };
    };
    ...
    template <typename D>
    struct consume_Windows_Networking_Vpn_IVpnChannel7Preview
    {
        auto SetErrorMessage(param::hstring const& message, uint32_t errCode) const;
        [[nodiscard]] auto ConnectionDetail() const;
        [[nodiscard]] auto DisconnectReason() const;
    };
    template <> struct consume<winrt::Windows::Networking::Vpn::IVpnChannel7Preview>
    {
        template <typename D> using type = consume_Windows_Networking_Vpn_IVpnChannel7Preview<D>;
    };
    template <typename D>
    ...
    template <typename D>
    struct consume_Windows_Networking_Vpn_IVpnConnectionDetailsPreview
    {
        [[nodiscard]] auto Type() const;
        [[nodiscard]] auto Attempt() const;
    };
    template <> struct consume<winrt::Windows::Networking::Vpn::IVpnConnectionDetailsPreview>
    {
        template <typename D> using type = consume_Windows_Networking_Vpn_IVpnConnectionDetailsPreview<D>;
    };
    template <typename D>
    ...
    template <typename D>
    struct consume_Windows_Networking_Vpn_IVpnManagementAgent2Preview
    {
        auto GetAlwaysOnActiveProfile() const;
        auto GetAlwaysOnActiveProfileAsync() const;
        auto SetAlwaysOnActiveProfile(winrt::Windows::Networking::Vpn::IVpnProfile const& profile) const;
        auto SetAlwaysOnActiveProfileAsync(winrt::Windows::Networking::Vpn::IVpnProfile const& profile) const;
    };
    template <> struct consume<winrt::Windows::Networking::Vpn::IVpnManagementAgent2Preview>
    {
        template <typename D> using type = consume_Windows_Networking_Vpn_IVpnManagementAgent2Preview<D>;
    };
    template <typename D>
