...
namespace winrt::impl
{
    template <typename D> auto consume_Microsoft_Windows_VisionInternal_IRecognizedTablesInternal<D>::GetTables() const
    {
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetTables(&result_impl_size, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>**)this;
            check_hresult(_winrt_abi_type->GetTables(&result_impl_size, &result));
        }
    ...
    template <typename D> auto consume_Microsoft_Windows_VisionInternal_IRecognizedTablesInternal<D>::GetTableCells(uint32_t tableIndex) const
    {
        uint32_t result_impl_size{};
        ...
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>)
        {
            ...
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->GetTableCells(tableIndex, &result_impl_size, &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::VisionInternal::IRecognizedTablesInternal>**)this;
    ...
    {
        void* result{};
        if constexpr (!std::is_same_v<D, winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>)
        {
            winrt::hresult _winrt_cast_result_code;
            auto const _winrt_casted_result = impl::try_as_with_reason<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6, D const*>(static_cast<D const*>(this), _winrt_cast_result_code);
            check_hresult(_winrt_cast_result_code);
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>**)&_winrt_casted_result;
            check_hresult(_winrt_abi_type->RecognizeTableFromImage(*(void**)(&imageBufferResource), impl::bind_in(options), tableRegions.size(), get_abi(tableRegions), &result));
        }
        else
        {
            auto const _winrt_abi_type = *(abi_t<winrt::Microsoft::Windows::VisionInternal::ITextRecognizerSession6>**)this;
            check_hresult(_winrt_abi_type->RecognizeTableFromImage(*(void**)(&imageBufferResource), impl::bind_in(options), tableRegions.size(), get_abi(tableRegions), &result));
        }
    ...
    {
        int32_t __stdcall GetTables(uint32_t* __resultSize, struct struct_Microsoft_Windows_VisionInternal_RecognizedTableInternal** result) noexcept final try
        {
            clear_abi(result);
        ...
        int32_t __stdcall GetTableCells(uint32_t tableIndex, uint32_t* __resultSize, struct struct_Microsoft_Windows_VisionInternal_RecognizedTableCellInternal** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
    ...
    {
        int32_t __stdcall RecognizeTableFromImage(void* imageBufferResource, struct struct_Microsoft_Windows_VisionInternal_TableRecognizerOptionsInternal options, uint32_t __tableRegionsSize, winrt::Windows::Foundation::Rect* tableRegions, void** result) noexcept final try
        {
            clear_abi(result);
            typename D::abi_guard guard(this->shim());
